...
### +Added Functions
def save_dict(file, saved_dict):
    with open(file, 'w') as f:
        for key in saved_dict.keys():
            f.write("%s\t%s\n"%(str(key),str(saved_dict[key])))
...
### +Added Instructions
    save_dict('../data/' + DATASET + '/i_map.txt', item_index_old2new)
    save_dict('../data/' + DATASET + '/u_map.txt', user_index_old2new)
### -Added Instructions
