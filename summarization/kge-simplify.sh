...
sv_kge-k-means() {
    ...
    then
        ...
        mv "$HOME/git/kg-summ-rec/docker/kge-k-means_data/temp/simplificated_triples.nt" "$HOME/git/datasets/${experiment}/${dataset_out}-${kge}-${ratio}/simplificated_triples.nt"
        mv "$HOME/git/kg-summ-rec/docker/kge-k-means_data/temp/triples_with_rank.tsv" "$HOME/git/datasets/${experiment}/${dataset_out}-${kge}-${ratio}/triples_with_rank.tsv"
...
mv_kge-k-means() {
    ...
    then
        ...
        mv "$HOME/git/kg-summ-rec/docker/kge-k-means_data/temp/cluster${ratio}.tsv" "$HOME/git/datasets/${experiment}/${dataset_out}-${kge}-${ratio}/cluster${ratio}.tsv"
        mv "$HOME/git/kg-summ-rec/docker/kge-k-means_data/temp/cluster${ratio}.png" "$HOME/git/datasets/${experiment}/${dataset_out}-${kge}-${ratio}/cluster${ratio}.png"
        mv "$HOME/git/kg-summ-rec/docker/kge-k-means_data/temp/simplificated_triples.tsv" "$HOME/git/datasets/${experiment}/${dataset_out}-${kge}-${ratio}/simplificated_triples.tsv"
        mv "$HOME/git/kg-summ-rec/docker/kge-k-means_data/temp/triples_with_rank.tsv" "$HOME/git/datasets/${experiment}/${dataset_out}-${kge}-${ratio}/triples_with_rank.tsv"
        cd $HOME/git/kg-summ-rec
    fi
