    ...
    then
        ...
        do
            ...
            then
                ...
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/i_map.dat" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/i_map.dat"
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/u_map.dat" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/u_map.dat"
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/i2kg_map.tsv" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/i2kg_map.tsv"
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/kg/e_map.dat" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/kg/e_map.dat"
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/kg/r_map.dat" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/kg/r_map.dat"
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/kg/train.dat" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/kg/train.dat"
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/kg/valid.dat" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/kg/valid.dat"
                ln -s "$HOME/git/datasets/${experiment}/ml-cao/kg/test.dat" "$HOME/git/datasets/${experiment}/fold${fold_number}/${dataset}/cao-format/ml1m/kg/test.dat"
