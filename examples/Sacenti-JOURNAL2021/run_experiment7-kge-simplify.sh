...
overall_comp_cost="$HOME/git/results/${experiment}/overall_comp_cost-hole-exp7.tsv"
...
#######################################
source $HOME/git/kg-summ-rec/summarization/kge-simplify.sh
...
run_experiment() {
    experiment=$1
    overall_comp_cost="$HOME/git/results/${experiment}/overall_comp_cost-exp7.tsv"
