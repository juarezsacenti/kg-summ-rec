...
#   run_experiments
#######################################
experiment='Sacenti-JOURNAL2021-type'
...
# FUNCTIONS:
#   gemsec 'experiment' 'dataset_in' 'dataset_out' 'kg_type' 'summarization_mode' 'kge' 'epochs' 'batch_size' learning_rate' 'low_frequence'
#######################################
...
####
recommend_sun_sfKG() {
    kg_recommendation "ml-sun_ho_fKG" "ml-sun_ho_sfKG"
}
