...
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/test.dat ~/git/datasets/ml1m-sun_sum3/ml1m/test.dat
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/sun_training.txt ~/git/datasets/ml1m-sun_sum3/ml1m/sun_training.txt
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/sun_test.txt ~/git/datasets/ml1m-sun_sum3/ml1m/sun_test.txt
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/negative.txt ~/git/datasets/ml1m-sun_sum3/ml1m/negative.txt

ln -s ~/git/datasets/ml1m-sun2cao/ml1m/train.dat ~/git/datasets/ml1m-sun_sum2/ml1m/train.dat
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/valid.dat ~/git/datasets/ml1m-sun_sum2/ml1m/valid.dat
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/test.dat ~/git/datasets/ml1m-sun_sum2/ml1m/test.dat
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/sun_training.txt ~/git/datasets/ml1m-sun_sum2/ml1m/sun_training.txt
ln -s ~/git/datasets/ml1m-sun2cao/ml1m/sun_test.txt ~/git/datasets/ml1m-sun_sum2/ml1m/sun_test.txt
...
python path-extraction-ml.py --training ../datasets/ml1m-sun_sum2/ml1m/sun_training.txt --negtive ../datasets/ml1m-sun_sum2/ml1m/negative.txt --auxiliary ../datasets/ml1m-sun_sum2/ml1m/auxiliary-mapping.txt --positivepath ../datasets/ml1m-sun_sum2/ml1m/positive-path.txt --negativepath ../datasets/ml1m-sun_sum2/ml1m/negative-path.txt --pathlength 3 --samplesize 5
...
#then
#    CUDA_VISIBLE_DEVICES=0 nohup python run_knowledge_representation.py -data_path ~/git/datasets/ml1m-sun_sum5/ -log_path ~/git/results/ml1m-sun_sum5/ -kg_test_files valid.dat:test.dat -l2_lambda 0 -model_type transr -nohas_visualization -dataset ml1m -batch_size 256 -embedding_size 100 -learning_rate 0.001 -topn 10 -seed 3 -eval_interval_steps 9150 -training_steps 915000 -early_stopping_steps_to_wait 45750 -optimizer_type Adam -L1_flag -norm_lambda 1 -kg_lambda 1 -load_ckpt_file ml1m-transe-pretrained.ckpt &
#    BACK_PID=$!
#    wait $BACK_PID
#fi

#[TRANSH]
#if no_exist "../results/ml1m-sun_sum5/ml1m-transh-*.log"
#then
#    CUDA_VISIBLE_DEVICES=0 nohup python run_knowledge_representation.py -data_path ~/git/datasets/ml1m-sun_sum5/ -log_path ~/git/results/ml1m-sun_sum5/ -kg_test_files valid.dat:test.dat -l2_lambda 0 -model_type transh -nohas_visualization -dataset ml1m -batch_size 256 -embedding_size 100 -learning_rate 0.001 -topn 10 -seed 3 -eval_interval_steps 9150 -training_steps 915000 -early_stopping_steps_to_wait 45750 -optimizer_type Adam -L1_flag -norm_lambda 1 -kg_lambda 1 -load_ckpt_file ml1m-transe-pretrained.ckpt &
#    BACK_PID=$!
#    wait $BACK_PID
#    mv ../results/ml1m-sun_sum5/ml1m-transh-*.ckpt_final ../results/ml1m-sun_sum5/ml1m-transh-pretrained.ckpt
#fi

#FM - Steffen Rendle. 2010. Factorization machines.
#if no_exist "../results/ml1m-sun_sum5/ml1m-fm-*.log"
#then
#    CUDA_VISIBLE_DEVICES=1 nohup python run_item_recommendation.py -data_path ~/git/datasets/ml1m-sun_sum5/ -log_path ~/git/results/ml1m-sun_sum5/ -rec_test_files valid.dat:test.dat -l2_lambda 1e-5 -negtive_samples 1 -model_type fm -nohas_visualization -dataset ml1m -batch_size 256 -embedding_size 100 -learning_rate 0.1 -topn 10 -seed 3 -eval_interval_steps 500 -training_steps 50000 -early_stopping_steps_to_wait 2500 -optimizer_type Adagrad &
#    BACK_PID=$!
#    wait $BACK_PID
#fi
