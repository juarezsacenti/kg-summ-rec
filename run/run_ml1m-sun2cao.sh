...
then
    ...
    BACK_PID=$!
    wait $BACK_PID
    mv ../results/ml1m-sun/ml1m-bprmf-*.ckpt_final ../results/ml1m-sun/ml1m-bprmf-pretrained.ckpt
fi
...
then
    ...
    BACK_PID=$!
    wait $BACK_PID
    mv ../results/ml1m-sun/ml1m-transup-*.ckpt_final ../results/ml1m-sun/ml1m-transup-pretrained.ckpt
fi
