...
#[TRANSE]
log_file="../results/ml1m-cao/ml1m-transe-*.log"
if [ -f "$log_file" ]
then
...
#[TRANSR]
log_file="../results/ml1m-cao/ml1m-transr-*.log"
if [ -f "$log_file" ]
then
...
#[TRANSH]
log_file="../results/ml1m-cao/ml1m-transh-*.log"
if [ -f "$log_file" ]
then
...
#TransUP
log_file="../results/ml1m-cao/ml1m-transup-*.log"
if [ -f "$log_file" ]
then
...
log_file="../results/ml1m-cao/ml1m-fm-*.log"
if [ -f "$log_file" ]
then
...
log_file="../results/ml1m-cao/ml1m-bprmf-*.log"
if [ -f "$log_file" ]
then
...
log_file="../results/ml1m-cao/ml1m-cfkg-*.log"
if [ -f "$log_file" ]
then
...
log_file="../results/ml1m-cao/ml1m-cke-*.log"
if [ -f "$log_file" ]
then
...
log_file="../results/ml1m-cao/ml1m-cofm-*.log"
if [ -f "$log_file" ]
then
...
#JTransUP
log_file="../results/ml1m-cao/ml1m-jtransup-*.log"
if [ -f "$log_file" ]
then
